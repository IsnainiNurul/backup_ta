...
if(sys.argv[3]=="semua"):
    query = "Select * from news where date between '"+str(sys.argv[1])+"' and '"+str(sys.argv[2])+"' and label='hoax';"
else:
    text=""
    ...
    query = "Select * from news where date between '"+str(sys.argv[1])+"' AND '"+str(sys.argv[2])+"' and area= '"+str(sys.argv[3])+"' and label='hoax';"
